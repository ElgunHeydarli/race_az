              ...
              <div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-[10px] lg:gap-[20px] w-full">
                  ...
                  {isFieldEnabled("individual_or_team") && (
                    <div style={{ order: getFieldOrder('individual_or_team', 5) * 2 }} className="col-span-full">
                                  ...
                                  <div>
                                    ...
                                    >
                                      {product.sizes.map((size) => (
                                        <option key={size.name} value={size.name} style={{ color: "#000", backgroundColor: "#fff" }} disabled={size.stock === 0}>
