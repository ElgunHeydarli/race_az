...
const PartnerForm = () => {
  ...
  return (
    <div className="flex flex-col align-center justify-start">
      <PartnersLogos
        customStyle={{ width: '100%', maxWidth: '90%', margin: '48px auto auto auto' }}
      />
          ...
          >
            ...
            >
              <h3 className="text-2xl sm:text-3xl md:text-[40px] font-display">
                {translateds('become_partner')}
              </h3>
              <p className="text-sm sm:text-[14px] text-white/80 max-w-md">
                {translateds('become_partner_desc')}
              </p>
            </motion.div>
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-[16px] w-full">
                <InputField
                  placeholder={translateds('name_surname')}
                  register={register('name')}
                  error={errors.name}
                />
                <InputField
                  placeholder={translateds('company_name')}
